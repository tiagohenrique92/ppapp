...
class PayeeWalletNotFoundException extends Exception implements DetailedExceptionInterface
{
    private const CODE = 7;
    private const MESSAGE = "Payee's wallet not found";
    private $details;
